package com.jeecg.downbyzip.service.impl;
...
@Service("downbyzipService")
@Transactional
public class DownbyzipServiceImpl extends CommonServiceImpl implements DownbyzipServiceI {
