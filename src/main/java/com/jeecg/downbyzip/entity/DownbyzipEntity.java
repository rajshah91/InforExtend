package com.jeecg.downbyzip.entity;
 ...
 */
@Entity
@Table(name = "downbyzip", schema = "")
@SuppressWarnings("serial")
public class DownbyzipEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="ASN",nullable=true,length=32)
