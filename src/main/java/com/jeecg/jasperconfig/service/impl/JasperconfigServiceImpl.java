package com.jeecg.jasperconfig.service.impl;
...
@Service("jasperconfigService")
@Transactional
public class JasperconfigServiceImpl extends CommonServiceImpl implements JasperconfigServiceI {
