package com.jeecg.printconfig.entity;
 ...
 */
@Entity
@Table(name = "PrintConfig", schema = "")
@SuppressWarnings("serial")
public class PrintconfigEntity implements java.io.Serializable {
	/**主键*/
	...
	/**打印机类型*/
	@Excel(name="打印机类型",width=15,dicCode="printtype")
	...
	@Column(name ="PRINTNAME",nullable=true,length=32)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  打印机类型
	 */

	@Column(name ="PRINTTYPE",nullable=true,length=32)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  ftp服务器地址
	 */

	@Column(name ="FTPADDRESS",nullable=true,length=32)
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  ftp服务器地址
	 */
	...
	@Column(name ="PATH",nullable=true,length=32)
