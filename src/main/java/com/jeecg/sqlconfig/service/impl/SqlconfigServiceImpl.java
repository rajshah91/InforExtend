package com.jeecg.sqlconfig.service.impl;
...
@Service("sqlconfigService")
@Transactional
public class SqlconfigServiceImpl extends CommonServiceImpl implements SqlconfigServiceI {
