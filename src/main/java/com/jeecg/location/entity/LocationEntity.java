package com.jeecg.location.entity;
...
public class LocationEntity implements java.io.Serializable {
	...
	/**库位类型*/
	@Excel(name="库位类型",width=15,dicCode="loc_type")
	...
	@Column(name ="LOC_CODE",nullable=true,length=32)
	...
	@Column(name ="LOC_NAME",nullable=true,length=32)
	...
	@Column(name ="LOC_TYPE",nullable=true,length=32)
