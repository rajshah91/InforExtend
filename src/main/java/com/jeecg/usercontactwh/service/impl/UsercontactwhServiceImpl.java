package com.jeecg.usercontactwh.service.impl;
...
@Service("usercontactwhService")
@Transactional
public class UsercontactwhServiceImpl extends CommonServiceImpl implements UsercontactwhServiceI {
