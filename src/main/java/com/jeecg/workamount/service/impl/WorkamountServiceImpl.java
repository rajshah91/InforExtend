package com.jeecg.workamount.service.impl;
...
@Service("workamountService")
@Transactional
public class WorkamountServiceImpl extends CommonServiceImpl implements WorkamountServiceI {
