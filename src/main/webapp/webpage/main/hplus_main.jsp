...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header" style="padding:0;">
                    <div class="dropdown profile-element">
                                <span><img alt="image" width="180" height="61" src="plug-in/login/images/feiliks.png" /></span>
                    </div>
                    <div class="logo-element">Infor
                    </div>
                </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer" style="border-top:none;">
            <div class="pull-right">&copy; <t:mutiLang langKey="system.version.number"/> <a href="http://sce.feili.com/feili/sce/sceapp.ctrl" target="_blank">Infor</a>
            </div>
        </div>        
    </div>
    <!--右侧部分结束-->
