	...
	<div id="downbyzipList" v-cloak>
		...
		<el-row style="background-color: #eee; padding: 10px 10px 0 10px;">
			<el-form :inline="true" :model="filters" size="mini" ref="filters">
				<el-form-item style="margin-bottom: 8px;" prop="asn">
					<el-input v-model="filters.asn" auto-complete="off" placeholder="请输入收货单号" style="width:175px"></el-input>
				</el-form-item>
				<el-form-item style="margin-bottom: 8px;" prop="lpn">
					<el-input v-model="filters.lpn" auto-complete="off" placeholder="请输入lpn" style="width:175px"></el-input>
				</el-form-item>
			    <br>
				<el-form-item>
			    	<el-button type="primary" icon="el-icon-search" v-on:click="getDownbyzips">查询</el-button>
			    </el-form-item>
			    <el-form-item>
			    	<el-button icon="el-icon-refresh" @click="resetForm('filters')">重置</el-button>
			    </el-form-item>
			    <el-form-item>
			    	<el-button icon="el-icon-download" @click="downloadzip">ZIP下载</el-button>
			    </el-form-item>
			    <!-- <el-form-item>
		...
		<el-dialog :title="formTitle" fullscreen z-index="800" :visible.sync="formVisible" :close-on-click-modal="false">
			<el-form :model="form" label-width="80px" :rules="formRules" ref="form" size="mini" inline="true">
					<el-form-item label="收货单号" prop="asn">
						<el-input v-model="form.asn" auto-complete="off" placeholder="请输入收货单号"></el-input>
					</el-form-item>
					<el-form-item label="lpn" prop="lpn">
						<el-input v-model="form.lpn" auto-complete="off" placeholder="请输入lpn"></el-input>
					</el-form-item>
			</el-form>
	...
	var vue = new Vue({			
		...
		methods: {
			...
			downloadzip: function() {
					window.location.href = this.url.downloadzip+"&lpn=1&ans=0";
			},
		    //列展示切换
			show:function(value){
				if(value=="asn"){
